terraform {
  ...
  backend "s3" {
    ...
    bucket     = "tfstate-laliga-dev"               
    key        = "dev/terraform.tfstate"        
    region     = "us-east-1"
    access_key = "DO00Z4GUZ8HWDVWWXVWZ"          
    secret_key = "rrht8SySmhn2UDqEl0THgKVZeyhKj6PfXiWkTP94104"         
    encrypt    = true                           
  ...
  # backend "s3" {
  #   bucket         = "fanclash-dev-tfstate"
  #   key            = "dev/terraform.tfstate"
  #   region         = "us-east-1"
  #   dynamodb_table = "fanclash-dev-tfstate"
  #   encrypt        = true
  #   # profile = "infra-dev"
  # }
}
